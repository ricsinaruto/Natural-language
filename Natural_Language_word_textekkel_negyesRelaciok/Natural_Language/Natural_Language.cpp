...
void thread2()
{
	...
	while (getline(filebe, sor))
	{
		if (sor[0] != '0' && elozo1sor[0]!='0' && elozo2sor[0]!='0'&& elozo3sor[0] != '0')
		{
			int i = 0;
			bool talalat = false;
			while (i<5969 && !talalat)
			{
				if (elozo3sor == szo[i].szo)
				{
					talalat = true;
				}
				i++;
			...
			if (talalat && talalat1 && talalat2 &&talalat3)
			{
				int z = 0;
				bool talalt = false;
